"""
collect_and_export_timellm.py

Collects all TimeLLM metrics from results/reactor_timellm/ and writes
...
Usage:
    python collect_and_export_timellm.py
"""
...
BASE = Path(__file__).parent / "results" / "reactor_timellm"
OUT  = Path(__file__).parent / "metrics_timellm.xlsx"
